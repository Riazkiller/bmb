...
logo=(green+""" \n\x1b[1;91m<<------------------------------------------------->>\n\x1b[1;93m\xe2\x9e\xa3 Author   : RIAZKHAN   \n\x1b[1;93m\xe2\x9e\xa3 From     : pakistan   \n\x1b[1;93m\xe2\x9e\xa3 FB Page : RIAZ-HACKER \n\x1b[1;93m\xe2\x9e\xa3 Help     : sent sms the +923188214452(RIAZ KHAN).\n\x1b[1;91m<<-------------------------------------------------->>\n
...
dtls=(yellow+"\t\t MODIFIED BY: RIAZKHAN ")

note=(cyan+"Note: I wont be responsible fo any illigal activites. >> This RedBomber tool is for use in pakistan only. Use our Global version for worldwide use.")
...
amount=int(input(cyan+"[âž™] Enter The Amount(1000) : "))
...
for i in range (amount):
	...
	print(str(i+1)+green+'.	âž™RIAZKHAN SEND ðŸ˜ˆâœ…')
	
print('					')
print(cyan+'\t\tThanks For Using RedBomber pakistani RK-RIAZ KHAN- ')
